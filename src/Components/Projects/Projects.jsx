...
export default function Projects({data,id}) {
  ...
  return (
    ...
    <div className="protfolio-content-img position-relative overflow-hidden" onClick={()=>display(id)} data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        <img src={data.image} alt=""/>
        <div className="portfolio-content">
        <i className='fa-solid fa-hand-pointer fa-fade fs-2'></i>
            <h5>{data.title}</h5>
            <div className="portfolio-skills text-center pt-3 pb-5 mx-2">
            <ul className='d-flex flex-wrap justify-content-center align-items-center p-0 mx-2'><li className='list-unstyled mt-2'>{data.skill_1}</li>
            ...
            {data.skill_5?<li className='list-unstyled mt-2'>{data.skill_5}</li>:null}</ul>
            </div>
        ...
        <div className="container p-5">
          <div className="row justify-content-center">
            <div className="col-md-10">
              ...
              <p  className='mt-0 fs-6 fw-semibold parg' id='parg'></p>
              ...
              <a href=" "rel="noreferrer"className="text-white d-inline" id='live'target="_blank"><button className='btn btn-dark'>Live Demo</button></a>
             </div>
          </div>
        </div>
      </div>
